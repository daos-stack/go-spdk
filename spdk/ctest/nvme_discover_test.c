...
void __wrap_cleanup(void){
	printf("Mock cleanup() runnning...\n");
}

void __wrap_collect(struct ret_t *ret){
	printf("Mock collect() runnning...\n");
}
...
{
	printf("Verifying expected parameters for spdk_nvme_probe...\n");
...
static void test_nvme_discover_null_g_controllers(void **state)
{
	...
	printf("Initializing return value for init_ret...\n");
